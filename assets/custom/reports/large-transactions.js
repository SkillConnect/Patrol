...
var spendShareByTransaction = function spendShareByTransaction() {
    var $horizontalBarChartEl = document.querySelector('.spend-share-transaction');
...
var spendShareByMerchants = function spendShareByMerchants() {
    var $pieChartEl = document.querySelector('.spend-share-merchant');
...
/* -------------------------------------------------------------------------- */
/* Echarts Pie Chart */
var spendShareByCategories = function spendShareByCategories() {
  var $pieChartEl = document.querySelector('.spend-share-category');
...
docReady(spendShareByTransaction);
docReady(spendShareByMerchants);
docReady(spendShareByCategories);